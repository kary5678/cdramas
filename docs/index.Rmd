...
The code used to scrape the data is included in the [GitHub repository.](https://github.com/kary5678/cdramas)
...
knitr::kable(most_eps, col.names=c("Title", "Year", "Episodes"))
```
...
knitr::kable(wuxias, col.names=c("Title", "Year", "Episodes"))
```
